...
export const Artifact: MessageFns<Artifact> = {
  ...
  fromJSON(object: any): Artifact {
    return {
      ...
      sha256Hex: isSet(object.sha256Hex) ? globalThis.String(object.sha256Hex) : "",
...
export const Release: MessageFns<Release> = {
  ...
  fromJSON(object: any): Release {
    return {
      ...
      emergencyUntil: isSet(object.emergencyUntil) ? globalThis.Number(object.emergencyUntil) : 0,
    };
  },
