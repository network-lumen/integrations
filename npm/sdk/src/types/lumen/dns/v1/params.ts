...
export const Params: MessageFns<Params> = {
  ...
  fromJSON(object: any): Params {
    return {
      ...
      graceDays: isSet(object.graceDays)
        ? globalThis.Number(object.graceDays)
        : isSet(object.grace_days)
        ? globalThis.Number(object.grace_days)
        : 0,
      auctionDays: isSet(object.auctionDays)
        ? globalThis.Number(object.auctionDays)
        : isSet(object.auction_days)
        ? globalThis.Number(object.auction_days)
        : 0,
      transferFeeUlmn: isSet(object.transferFeeUlmn)
        ? globalThis.Number(object.transferFeeUlmn)
        : isSet(object.transfer_fee_ulmn)
        ? globalThis.Number(object.transfer_fee_ulmn)
        : 0,
      bidFeeUlmn: isSet(object.bidFeeUlmn)
        ? globalThis.Number(object.bidFeeUlmn)
        : isSet(object.bid_fee_ulmn)
        ? globalThis.Number(object.bid_fee_ulmn)
        : 0,
      updateRateLimitSeconds: isSet(object.updateRateLimitSeconds)
        ? globalThis.Number(object.updateRateLimitSeconds)
        : isSet(object.update_rate_limit_seconds)
        ? globalThis.Number(object.update_rate_limit_seconds)
        : 0,
      updatePowDifficulty: isSet(object.updatePowDifficulty)
        ? globalThis.Number(object.updatePowDifficulty)
        : isSet(object.update_pow_difficulty)
        ? globalThis.Number(object.update_pow_difficulty)
        : 0,
      domainTiers: globalThis.Array.isArray(object?.domainTiers)
        ? object.domainTiers.map((e: any) => LengthTier.fromJSON(e))
        : globalThis.Array.isArray(object?.domain_tiers)
        ? object.domain_tiers.map((e: any) => LengthTier.fromJSON(e))
        : [],
      extTiers: globalThis.Array.isArray(object?.extTiers)
        ? object.extTiers.map((e: any) => LengthTier.fromJSON(e))
        : globalThis.Array.isArray(object?.ext_tiers)
        ? object.ext_tiers.map((e: any) => LengthTier.fromJSON(e))
        : [],
      minPriceUlmnPerMonth: isSet(object.minPriceUlmnPerMonth)
        ? globalThis.Number(object.minPriceUlmnPerMonth)
        : isSet(object.min_price_ulmn_per_month)
        ? globalThis.Number(object.min_price_ulmn_per_month)
        : 0,
      updateFeeUlmn: isSet(object.updateFeeUlmn)
        ? globalThis.Number(object.updateFeeUlmn)
        : isSet(object.update_fee_ulmn)
        ? globalThis.Number(object.update_fee_ulmn)
        : 0,
    };
  },
  ...
  fromJSON(object: any): LengthTier {
    return {
      maxLen: isSet(object.maxLen)
        ...
        : 0,
      multiplierBps: isSet(object.multiplierBps)
        ? globalThis.Number(object.multiplierBps)
        : isSet(object.multiplier_bps)
        ? globalThis.Number(object.multiplier_bps)
        : 0,
    };
  },
